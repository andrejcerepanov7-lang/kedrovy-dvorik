        ...
        rooms: [
            {
                ...
                price: '7 000 ₽',
                image: 'https://i.ibb.co/HfdDySWV/x-TM7-IQN8v-d-A33u-CX-LMo-Ydt4-Mp-LHx-Thz-Xy1-6a-OKf-YIw-Hw-Rhcr3-Ie-SXAWUt-BHVSn-RDYXf9t3-N5-Qa25-Rvb-Ibz.jpg',
                gallery: [
                ...
                description: 'Уютный номер для двоих. Всё необходимое для комфортного отдыха: двуспальная кровать, бесплатный Wi-Fi, санузел с душем. Отличный вариант для пары.'
            },
            {
                id: 2,
                name: 'Номер-студия на 4 человек',
                price: '7 000 ₽',
                image: 'https://i.ibb.co/DgKDSWT9/mndm-Uh-OUOvl0-R1vkt-XPJ3g-C8-Bh-Ega-Gi-S8-Jn-TKJt-D87-YU1-Mj-Xf-FMZa-Udy2g-W0-Re3b-ORLpr-ALNcg.jpg',
                gallery: [
                ...
                description: 'Просторная студия для компании до 4 человек. Двуспальная кровать + диван-кровать. Есть мини-кухня с холодильником и чайником. Идеально для семейного отдыха или компании друзей.'
            },
            {
                id: 3,
                name: 'Благоустроенный дом с двумя комнатами на 5 человек + доп место',
                price: '8 000 ₽',
                image: 'https://i.ibb.co/v6M9V1rN/v-Vi-Kg-Fmz-LKw-EJhs-HLlb-Cd7b-V1ph-B4to-Ip-KDhz2vsnzk-Y0-Bdh-MN42-YUx-Yx7x1n-IEZWYt-Qk2-M3a-Q.jpg',
                gallery: [
                ...
                description: 'Дом для большой компании. Две отдельные комнаты, две двуспальные кровати + раскладное кресло + односпальная кровать. Полностью оборудованная кухня. Есть возможность установить дополнительное спальное место.'
            },
            {
                id: 4,
            ...
            },
            {
                ...
                price: '3 600 ₽',
                image: 'https://i.ibb.co/HTHG46SY/OHViy-FYd-Vet-L1-EHt-WCPVw-Wn-YGZbax-WZx-DBc7w-Gq-Oi1cz-Rte-IQj-Tx-Fsl-BDiiu-Di-HEm7-Yn5-Ml8-Wl-Dw.jpg',
                gallery: [
                ...
                description: 'Уютный летний номер для троих. Двуспальная и односпальная кровать. В номере: стол, раковина. Душ и туалет на территории, кухонная зона в беседке. Идеально для небольшой компании.'
            },
            {
                id: 6,
                name: 'Двухместный летний номер на 2 этаже (двуспальная кровать)',
                price: '2 400 ₽',
                image: 'https://i.ibb.co/ymchdC6z/Qr-DVq-Cd-CXeo-Ti-E1-W0-MH2-Rs-QLMCy-W6k-KV7-Fh-D6fc-I2u-Dk-FOvgf-Rw-BQp-Fa-XVL5-Fi-G1-O5-Ot8-MC2s-A.jpg',
                gallery: [
                    'https://i.ibb.co/XZMqd5RW/iu8b-YO0-ABF5-Eh-VXo2ka0-ORQyy-Pm1-Hn-Gm-YOuz-Az-Cm4k-Jl-Bx-Jn-FYAhqi-Qh-GM2g-QNOho-Qw-9d31l-C0ka-Cw.jpg'
                ],
                description: 'Светлый номер на втором этаже с двуспальной кроватью. Отличный вид из окна. Душ и туалет на территории, кухонная зона в беседке. Для тех, кто ценит уединение и атмосферу.'
            },
            {
                id: 7,
                name: 'Двухместный летний номер на 2 этаже (две односпальные кровати)',
                price: '2 400 ₽',
                image: 'https://i.ibb.co/SDqNMqty/FZ2-Bj-Vl-Cl-Bd-Qt-FFpp-Kr-Z1fa-Rx-XSd-Soy-Dp-Cq-IAWw-I5-Dw-VVIE5n-Hj-K9-G7-L9p-M7-HUSs-Qc5-Yk-WMl-Ug.jpg',
                gallery: [
                    'https://i.ibb.co/XZMqd5RW/iu8b-YO0-ABF5-Eh-VXo2ka0-ORQyy-Pm1-Hn-Gm-YOuz-Az-Cm4k-Jl-Bx-Jn-FYAhqi-Qh-GM2g-QNOho-Qw-9d31l-C0ka-Cw.jpg'
                ],
                description: 'Комфортный номер на втором этаже с двумя односпальными кроватями. Душ и туалет на территории, кухонная зона в беседке. Подходит для друзей или коллег.'
            }
        ]
    };
}
            ...
            <div class="info">
                ...
                ${room.gallery && room.gallery.length > 0 ? `
                    <div class="room-gallery-thumbs">
                        ${room.gallery.slice(0, 4).map(img => `
                            <a href="${img}" data-lightbox="room-${room.id}" data-title="${room.name}">
                                <img src="${img}" alt="Фото">
                            </a>
                        `).join('')}
                        ${room.gallery.length > 4 ? `<span style="font-size:13px;color:#999;align-self:center;">+${room.gallery.length - 4}</span>` : ''}
                    </div>
                ` : ''}
            </div>
        </div>
